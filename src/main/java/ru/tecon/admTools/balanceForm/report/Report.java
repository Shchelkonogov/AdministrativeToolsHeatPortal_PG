...
public final class Report {
    ...
    public static Workbook createMonthReport(int object, LocalDate reportDate, BalanceFormReportSBLocal loader) {
    ...
    private static void createSheet(Workbook wb, DateTimeFormatter formatter, LocalDate date, int object, BalanceFormReportSBLocal loader,
