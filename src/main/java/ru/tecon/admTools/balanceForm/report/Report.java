package ru.tecon.admTools.balanceForm.report;
...
import ru.tecon.admTools.balanceForm.report.model.MyStyleName;
...
public final class Report {
    ...
    public static Workbook createMonthReport(int object, LocalDate startDate, LocalDate endDate, BalanceFormReportSBLocal loader) {
    ...
    public static Workbook createDayReport(int object, LocalDate reportDate, BalanceFormReportSBLocal loader) {
        Workbook wb = new XSSFWorkbook();
        createSheet(wb, reportDate, reportDate, object, loader, new PropertyTemplate(), getStyles(wb));
        return wb;
    }

    private static void createSheet(Workbook wb, LocalDate startDate, LocalDate endDate, int object, BalanceFormReportSBLocal loader,
