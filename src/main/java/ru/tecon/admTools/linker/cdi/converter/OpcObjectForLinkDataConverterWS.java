...
/**
 * Конвертер для определения id для таблицы "Линкованные объекты / Объекты" кнопка "Долинковать"
 *
 * @author Maksim Shchelkonogov
 * 02.08.2023
 */
public class OpcObjectForLinkDataConverterWS implements Converter<Object> {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        return linkerController.getOpcObjectsForLinkData().getWrappedData().stream()
